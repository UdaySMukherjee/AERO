function findMinimumDistance() {
  ...
  if (closestLocation) {
    ...
    var graphs1 = document.getElementsByClassName("graph1");
    var graphs2 = document.getElementsByClassName("graph2");
    var graphs3 = document.getElementsByClassName("graph3");
    var graphs4 = document.getElementsByClassName("graph4");
    var graphs5 = document.getElementsByClassName("graph5");
    for (var i = 0; i < graphs.length; i++) {
      if (closestLocation.name === "Uday") {
        graphs1[i].style.display = "flex";
      }
      if (closestLocation.name === "Sukrit") {
        graphs2[i].style.display = "flex";
      }
      if (closestLocation.name === "Ayan") {
        graphs3[i].style.display = "flex";
      }
      if (closestLocation.name === "Ayantik") {
        graphs4[i].style.display = "flex";
      }
      if (closestLocation.name === "Atrij") {
        graphs5[i].style.display = "flex";
      }
      else {
        graphs1[i].style.display = "none";
        graphs2[i].style.display = "none";
        graphs3[i].style.display = "none";
        graphs4[i].style.display = "none";
        graphs5[i].style.display = "none";
      }
    }
  } else {
